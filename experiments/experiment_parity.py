...
parser.add_argument("--embedding_dim", default=32, type=int, help="dimensionality of embedding space")
parser.add_argument("--hidden_size", default=128, type=int, help="dimensionality of hidden state in LSTM")
...
parser.add_argument("--word_dropout", default=0, type=float, help="word dropout probability")
...
transform = EncodeInteger(token_map=token_map, tokenizer=word_tokenizer)
