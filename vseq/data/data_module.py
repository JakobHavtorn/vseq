...
# TODO Add support for other sampling than 'shuffle'. Replace 'shuffle=True' by 'RandomSampler' as new default with
#      same behaviour as before but allow using other samplers including custom.
...
def get_dataset(dataset_name: str):
    ...
    return getattr(vseq.data, dataset_name)
...
class DataModule:
    ...
    def __init__(
        ...
        The 'class name' should be that of a dataset in 'vseq.data'. If giving multiple different versions
