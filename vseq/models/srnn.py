...
class SRNN(nn.Module):
    def __init__(self, x_dim, h_dim, z_dim, n_layers, bias=False):
        ...
        self.enc = nn.Sequential(nn.Linear(h_dim, h_dim), nn.ReLU(), nn.Linear(h_dim, h_dim), nn.ReLU())
    ...
    def forward(self, x, y):
        # TODO Rename y to u
        # TODO If u is not given, default to being x one timestep in the past
        ...
        # TODO Use x.unbind() and u.unbind() to get iterable tuples of tensors
        # TODO Make this a single call to a GRU/LSTM
        ...
        for t in range(x.size(0)):
            ...
            # prior transition,
            # TODO Condition this on the previously sampled z
            ...
            # TODO Implement residual parameterization of posterior
            ...
            # computing losses
            # TODO Compute the KL in vectorized form
            kld_loss += self._kld_gauss(enc_mean_t, enc_std_t, prior_mean_t, prior_std_t)
            # TODO Use a likelihood module here instead
