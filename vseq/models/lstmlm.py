...
class LSTMLM(BaseModel):
    def __init__(
        ...
        **lstm_kwargs,
        ...
        self.lstm = rnn_layer(input_size=embedding_dim, hidden_size=hidden_size, batch_first=False, **lstm_kwargs)
    ...
    def forward(self, x, x_sl) -> Tuple[torch.Tensor, List[Metric], SimpleNamespace]:
